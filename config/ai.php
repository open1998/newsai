...
return [
    ...
    */
    ...
    'default' => env('AI_PROVIDER', 'deepseek-custom'),
    ...
    */
    ...
    'providers' => [
        ...
        /**
         * DeepSeek via a custom OpenAI-compatible API endpoint.
         *
         * Used for article rewriting with deepseek-v4-flash.
         * Set DEEPSEEK_API_URL to the base URL (e.g., https://api.deepseek.com/v1)
         * and DEEPSEEK_API_KEY to your API key.
         */
        'deepseek-custom' => [
            'driver' => 'openai-compatible',
